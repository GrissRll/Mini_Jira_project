...
class UserRepository:
    ...
    async def get_users_on_filters(
        self, filters: ColumnElement, page_num: int, page_size: int
    ) -> Sequence[UserModel]:
        """ "
    ...
    def _buid_and_filter(
        self,
        user_name: str | None = None,
        email: EmailStr | str | None = None,
        user_id: int | None = None,
    ) -> ClauseElement | None | ColumnElement[bool]:
    ...
    def _build_or_filter(
        self, user_name: str | None, email: EmailStr | None
    ) -> ClauseElement | None | ColumnElement[bool]:
        filters = []
        if user_name:
            filters.append(UserModel.user_name == user_name)
